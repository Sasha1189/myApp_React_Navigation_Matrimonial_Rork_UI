...
import { HeightPickerField } from "../form/HeightSelectField";
              ...
              <Controller
                ...
                render={({ field: { onChange, value } }) => (
                  <PickerField
                    ...
                    placeholder={t("details.placeholders.bodyType")}
                    value={value}
              ...
              <Controller
                ...
                render={({ field: { onChange, value } }) => (
                  <PickerField
                    ...
                    placeholder={t("details.placeholders.manglik")}
                    value={value}
              ...
              <Controller
                ...
                render={({ field: { onChange, value } }) => (
                  <PickerField
                    ...
                    placeholder={t("details.placeholders.rashi")}
                    value={value}
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <PickerField
                ...
                placeholder={t("details.placeholders.horoscopeRequired")}
                value={value}
